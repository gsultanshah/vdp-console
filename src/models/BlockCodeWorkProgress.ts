...
const BlockCodeWorkProgressSchema = new mongoose.Schema(
  {
    ...
    comments: { type: String, default: '' },
    requestParchiGeneration: { type: Boolean, default: false },
    parchiFingerprint: { type: String, default: null },
    parchiFingerprintPending: { type: String, default: null },
    parchiJobId: { type: String, default: null },
    parchiCompletedAt: { type: Date, default: null },
