        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            <div className="flex-shrink-0">
              <h1 className="text-2xl font-bold text-indigo-600">VDP Console</h1>
            </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            <h1 className="text-4xl tracking-tight font-extrabold text-gray-900 sm:text-5xl md:text-6xl">
              ...
              <span className="block text-indigo-600">VDP Console</span>
            </h1>
            <p className="mt-3 max-w-md mx-auto text-base text-gray-500 sm:text-lg md:mt-5 md:text-xl md:max-w-3xl">
              Your all-in-one solution for managing and monitoring your virtual data platform.
            </p>
...
const features = [
  {
    ...
    description: 'Monitor your data platform in real-time with comprehensive analytics and insights.',
    icon: '📊',
  },
  {
  ...
  },
  {
    ...
    description: 'Easily manage and organize your data with intuitive tools and interfaces.',
    icon: '🗄️',
  },
  {
